...
async function crearAccion(id, descripcion) {
    const connection = await pool.getConnection();
    try {
        await connection.execute('INSERT INTO acciones (id, descripcion) VALUES (?, ?)', [id, descripcion]);
...
module.exports = {crearUsuario,crearAccion,crearGrupo,eliminarUsuario,eliminarAccion,eliminarGrupo};